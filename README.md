# Super Mario Bros: Custom Sprite ROM Hack

### Description
- This project is a custom ROM hack of the original Super Mario Bros for the NES. The main goal was to replace Mario’s character sprite with a fully custom, original sprite using pixel art tools and ROM editing techniques. The modified sprite was manually designed and inserted into the ROM using the Mesen emulator, Tile Layer Pro, and HxD hex editor. 
---
